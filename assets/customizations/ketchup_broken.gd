...
func setup(pos: Vector3, rot: Vector3, bullet_global_transform: Transform):
	$smash.stream.loop = false
	$Particles.process_material.direction = bullet_global_transform.basis.z.normalized() + rot
